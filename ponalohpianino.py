...
introduce1 = play.new_text(words = 'мега крутое фортепиано', x = 0, y = 200)
introduce1 = play.new_text(words = 'играй, нажимая на клавиши', x = 0, y = 150)
key_clear_melody = play.new_box(color='DarkKhaki', border_color = 'black', border_width=1, x=100, y=-170, width=160, height=50)
kcm = play.new_text(words='удалить', x=100, y=-170, font_size=20)

key_play_melody = play.new_box(color='HotPink', border_color = 'black', border_width=1, x=-100, y=-170, width=160, height=50)
kcm = play.new_text(words='играть', x=-100, y=-170, font_size=20)
